...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-ptr-ptrAtts-13-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-ref-refAtts-14-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-list-gloss-list-must-have-labels-15-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-relatedItem-targetorcontent1-16-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-l-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-lg-atleast1oflggapl-18-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-lg-abstractModel-structure-l-19-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-s-noNestedS-20-->


	  <!--RULE -->
   <xsl:template match="tei:s" priority="1000" mode="M28">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-span-targetfrom-21-->
...
Only one of the attributes @target and @from may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-span-targetto-22-->
...
Only one of the attributes @target and @to may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-span-tonotfrom-23-->
...
If @to is supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-span-tofrom-24-->


	  <!--RULE -->
   <xsl:template match="tei:span" priority="1000" mode="M32">
...
The attributes @to and @from on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-quotation-quotationContents-25-->


	  <!--RULE -->
   <xsl:template match="tei:quotation" priority="1000" mode="M33">
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-link-linkTargets3-26-->


	  <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M34">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-ab-abstractModel-structure-ab-27-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-ab-abstractModel-structure-l-28-->


	  <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M36">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-join-joinTargets3-29-->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-standOff-nested_standOff_should_be_typed-30-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-catchwords-catchword_in_msDesc-31-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-dimensions-duplicateDim-32-->
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-secFol-secFol_in_msDesc-33-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-signatures-signatures_in_msDesc-34-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-msIdentifier-msId_minimal-35-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-relation-reforkeyorname-36-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-relation-activemutual-37-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-relation-activepassive-38-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-objectIdentifier-objectIdentifier_minimal-39-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-shift-shiftNew-40-->


	  <!--RULE -->
   <xsl:template match="tei:shift" priority="1000" mode="M48">
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.repeatable-MINandMAXoccurs-41-->


	  <!--RULE -->
   <xsl:template match="*[ @minOccurs  and  @maxOccurs ]" priority="1001" mode="M49">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.identified-spec-in-module-42-->
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.deprecated-validUntil-deprecation-two-month-warning-43-->


	  <!--RULE -->
   <xsl:template match="tei:*[@validUntil]" priority="1000" mode="M51">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.deprecated-validUntil-deprecation-should-be-explained-44-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-moduleRef-modref-45-->


	  <!--RULE -->
   <xsl:template match="tei:moduleRef" priority="1000" mode="M53">
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-moduleRef-prefix-not-same-prefix-46-->


	  <!--RULE -->
   <xsl:template match="tei:moduleRef" priority="1000" mode="M54">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-model-no_dup_default_models-47-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-model-no_dup_models-48-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-modelSequence-no_outputs_nor_predicates_4_my_kids-49-->


	  <!--RULE -->
   <xsl:template match="tei:modelSequence" priority="1000" mode="M57">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-sequence-sequencechilden-50-->


	  <!--RULE -->
   <xsl:template match="tei:sequence" priority="1000" mode="M58">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-alternate-alternatechilden-51-->


	  <!--RULE -->
   <xsl:template match="tei:alternate" priority="1000" mode="M59">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-constraintSpec-sch_no_more-52-->


	  <!--RULE -->
   <xsl:template match="tei:constraintSpec" priority="1000" mode="M60">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-constraintSpec-isosch-53-->


	  <!--RULE -->
   <xsl:template match="tei:constraintSpec" priority="1000" mode="M61">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-constraintSpec-needrules-54-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-attDef-attDefContents-55-->


	  <!--RULE -->
   <xsl:template match="tei:attDef" priority="1000" mode="M63">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-attDef-noDefault4Required-56-->


	  <!--RULE -->
   <xsl:template match="tei:attDef[@usage eq 'req']" priority="1000" mode="M64">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-attDef-defaultIsInClosedList-twoOrMore-57-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-attDef-defaultIsInClosedList-one-58-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-dataRef-restrictDataFacet-59-->


	  <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M67">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-dataRef-restrictAttRestriction-60-->


	  <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M68">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-rdgGrp-only1lem-61-->


	  <!--RULE -->
   <xsl:template match="tei:rdgGrp" priority="1000" mode="M69">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-variantEncoding-location-variantEncodingLocation-62-->


	  <!--RULE -->
   <xsl:template match="tei:variantEncoding" priority="1000" mode="M70">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-div-abstractModel-structure-l-65-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-div-abstractModel-structure-p-66-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-path-pathmustnotbeclosed-67-->


	  <!--RULE -->
   <xsl:template match="tei:path[@points]" priority="1000" mode="M73">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-addSpan-spanTo-68-->


	  <!--RULE -->
   <xsl:template match="tei:addSpan" priority="1000" mode="M74">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-damageSpan-spanTo-70-->


	  <!--RULE -->
   <xsl:template match="tei:damageSpan" priority="1000" mode="M75">
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-delSpan-spanTo-72-->


	  <!--RULE -->
   <xsl:template match="tei:delSpan" priority="1000" mode="M76">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-subst-substContents1-74-->


	  <!--RULE -->
   <xsl:template match="tei:subst" priority="1000" mode="M77">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:value" priority="1000" mode="M78">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:unicodeName" priority="1000" mode="M79">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:localName" priority="1000" mode="M80">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:glyphName" priority="1000" mode="M81">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:charProp" priority="1000" mode="M82">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:charName" priority="1000" mode="M83">
