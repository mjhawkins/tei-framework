...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-ptr-ptrAtts-13-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-ref-refAtts-14-->
   ...
   <!--PATTERN schematron-constraint-tei_all-list-gloss-list-must-have-labels-15-->
   ...
   <!--PATTERN schematron-constraint-tei_all-relatedItem-targetorcontent1-16-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_all-l-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_all-lg-atleast1oflggapl-18-->
   ...
   <!--PATTERN schematron-constraint-tei_all-lg-abstractModel-structure-l-19-->
   ...
   <!--PATTERN schematron-constraint-tei_all-s-noNestedS-20-->
   ...
   <!--PATTERN schematron-constraint-tei_all-span-targetfrom-21-->
...
Only one of the attributes @target and @from may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-span-targetto-22-->
...
Only one of the attributes @target and @to may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-span-tonotfrom-23-->
...
If @to is supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-span-tofrom-24-->
...
The attributes @to and @from on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-quotation-quotationContents-25-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-link-linkTargets3-26-->
   ...
   <!--PATTERN schematron-constraint-tei_all-ab-abstractModel-structure-ab-27-->
   ...
   <!--PATTERN schematron-constraint-tei_all-ab-abstractModel-structure-l-28-->
   ...
   <!--PATTERN schematron-constraint-tei_all-join-joinTargets3-29-->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-standOff-nested_standOff_should_be_typed-30-->
   ...
   <!--PATTERN schematron-constraint-tei_all-catchwords-catchword_in_msDesc-31-->
   ...
   <!--PATTERN schematron-constraint-tei_all-dimensions-duplicateDim-32-->
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-secFol-secFol_in_msDesc-33-->
   ...
   <!--PATTERN schematron-constraint-tei_all-signatures-signatures_in_msDesc-34-->
   ...
   <!--PATTERN schematron-constraint-tei_all-msIdentifier-msId_minimal-35-->
   ...
   <!--PATTERN schematron-constraint-tei_all-relation-reforkeyorname-36-->
   ...
   <!--PATTERN schematron-constraint-tei_all-relation-activemutual-37-->
   ...
   <!--PATTERN schematron-constraint-tei_all-relation-activepassive-38-->
   ...
   <!--PATTERN schematron-constraint-tei_all-objectIdentifier-objectIdentifier_minimal-39-->
   ...
   <!--PATTERN schematron-constraint-tei_all-shift-shiftNew-40-->
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_all-rdgGrp-only1lem-41-->
   ...
   <!--PATTERN schematron-constraint-tei_all-variantEncoding-location-variantEncodingLocation-42-->
   ...
   <!--PATTERN schematron-constraint-tei_all-div-abstractModel-structure-l-45-->
   ...
   <!--PATTERN schematron-constraint-tei_all-div-abstractModel-structure-p-46-->
   ...
   <!--PATTERN schematron-constraint-tei_all-path-pathmustnotbeclosed-47-->


	  <!--RULE -->
   <xsl:template match="tei:path[@points]" priority="1000" mode="M53">
   ...
   <!--PATTERN schematron-constraint-tei_all-addSpan-spanTo-48-->
   ...
   <!--PATTERN schematron-constraint-tei_all-damageSpan-spanTo-50-->
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-delSpan-spanTo-52-->


	  <!--RULE -->
   <xsl:template match="tei:delSpan" priority="1000" mode="M56">
   ...
   <!--PATTERN schematron-constraint-tei_all-subst-substContents1-54-->


	  <!--RULE -->
   <xsl:template match="tei:subst" priority="1000" mode="M57">
   ...
   <!--PATTERN schematron-constraint-tei_all-att.repeatable-MINandMAXoccurs-55-->


	  <!--RULE -->
   <xsl:template match="*[ @minOccurs  and  @maxOccurs ]" priority="1001" mode="M58">
   ...
   <!--PATTERN schematron-constraint-tei_all-att.identified-spec-in-module-56-->
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN schematron-constraint-tei_all-att.deprecated-validUntil-deprecation-two-month-warning-57-->


	  <!--RULE -->
   <xsl:template match="tei:*[@validUntil]" priority="1000" mode="M60">
   ...
   <!--PATTERN schematron-constraint-tei_all-att.deprecated-validUntil-deprecation-should-be-explained-58-->
   ...
   <!--PATTERN schematron-constraint-tei_all-moduleRef-modref-59-->
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-moduleRef-prefix-not-same-prefix-60-->
   ...
   <!--PATTERN schematron-constraint-tei_all-model-no_dup_default_models-61-->
   ...
   <!--PATTERN schematron-constraint-tei_all-model-no_dup_models-62-->
   ...
   <!--PATTERN schematron-constraint-tei_all-modelSequence-no_outputs_nor_predicates_4_my_kids-63-->
   ...
   <!--PATTERN schematron-constraint-tei_all-sequence-sequencechilden-64-->


	  <!--RULE -->
   <xsl:template match="tei:sequence" priority="1000" mode="M67">
   ...
   <!--PATTERN schematron-constraint-tei_all-alternate-alternatechilden-65-->


	  <!--RULE -->
   <xsl:template match="tei:alternate" priority="1000" mode="M68">
   ...
   <!--PATTERN schematron-constraint-tei_all-constraintSpec-sch_no_more-66-->
   ...
   <!--PATTERN schematron-constraint-tei_all-constraintSpec-isosch-67-->


	  <!--RULE -->
   <xsl:template match="tei:constraintSpec" priority="1000" mode="M70">
   ...
   <!--PATTERN schematron-constraint-tei_all-constraintSpec-needrules-68-->
   ...
   <!--PATTERN schematron-constraint-tei_all-attDef-attDefContents-69-->
   ...
   <!--PATTERN schematron-constraint-tei_all-attDef-noDefault4Required-70-->
   ...
   <!--PATTERN schematron-constraint-tei_all-attDef-defaultIsInClosedList-twoOrMore-71-->
   ...
   <!--PATTERN schematron-constraint-tei_all-attDef-defaultIsInClosedList-one-72-->
   ...
   <!--PATTERN schematron-constraint-tei_all-dataRef-restrictDataFacet-73-->
   ...
   <!--PATTERN schematron-constraint-tei_all-dataRef-restrictAttRestriction-74-->
