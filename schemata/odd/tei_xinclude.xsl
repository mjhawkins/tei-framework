...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:esp-d2e55498="http://www.w3.org/2001/XInclude"
                xmlns:esp-d2e55569="http://www.w3.org/2001/XInclude"
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-ptr-ptrAtts-13-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-ref-refAtts-14-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-list-gloss-list-must-have-labels-15-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-relatedItem-targetorcontent1-16-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-l-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-lg-atleast1oflggapl-18-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-lg-abstractModel-structure-l-19-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-quotation-quotationContents-20-->


	  <!--RULE -->
   <xsl:template match="tei:quotation" priority="1000" mode="M25">
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-div-abstractModel-structure-l-23-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-div-abstractModel-structure-p-24-->
