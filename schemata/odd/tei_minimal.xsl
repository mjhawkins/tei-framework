...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN schematron-constraint-tei_minimal-att.measurement-att-measurement-unitRef-5-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-att.typed-subtypeTyped-6-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-att.pointing-targetLang-targetLang-7-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-att.spanning-spanTo-spanTo-2-8-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_minimal-att.styleDef-schemeVersion-schemeVersionRequiresScheme-9-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-p-abstractModel-structure-p-10-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-p-abstractModel-structure-l-11-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-desc-deprecationInfo-only-in-deprecated-12-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-ptr-ptrAtts-13-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_minimal-ref-refAtts-14-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-list-gloss-list-must-have-labels-15-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-relatedItem-targetorcontent1-16-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_minimal-l-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-lg-atleast1oflggapl-18-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-lg-abstractModel-structure-l-19-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-quotation-quotationContents-20-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_minimal-div-abstractModel-structure-l-23-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-div-abstractModel-structure-p-24-->
