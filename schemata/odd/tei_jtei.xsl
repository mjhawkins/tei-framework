...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_jtei-table-jtei.sch-table-31-->


	  <!--RULE -->
   <xsl:template match="tei:table" priority="1000" mode="M40">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-titleStmt-jtei.sch-title-32-->


	  <!--RULE -->
   <xsl:template match="tei:titleStmt" priority="1000" mode="M41">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-idno-jtei.sch-doi-order-33-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-rendition-jtei.sch-rendition-34-->


	  <!--RULE -->
   <xsl:template match="tei:rendition" priority="1000" mode="M43">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-att-jtei.sch-att-35-->


	  <!--RULE -->
   <xsl:template match="tei:att" priority="1000" mode="M44">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-tag-jtei.sch-tag-36-->


	  <!--RULE -->
   <xsl:template match="tei:tag" priority="1000" mode="M45">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-val-jtei.sch-att-37-->


	  <!--RULE -->
   <xsl:template match="tei:val" priority="1000" mode="M46">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-text-jtei.sch-article-keywords-40-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-text-jtei.sch-article-abstract-41-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-text-jtei.sch-article-back-42-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-body-jtei.sch-body-43-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-jtei.sch-divtypes-front-44-->
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message>
               ...
               <xsl:text/> may only occur inside front.
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-jtei.sch-divtypes-front2-45-->


	  <!--RULE -->
   <xsl:template match="tei:front/tei:div" priority="1000" mode="M52">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-jtei.sch-divtypes-back-46-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-jtei.sch-divtypes-body-47-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-jtei.sch-div-head-48-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-abstractModel-structure-l-49-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-abstractModel-structure-p-50-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-front-jtei.sch-front-abstract-51-->


	  <!--RULE -->
   <xsl:template match="tei:front" priority="1000" mode="M58">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-back-jtei.sch-back-52-->


	  <!--RULE -->
   <xsl:template match="tei:back" priority="1000" mode="M59">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-supplied-jtei.sch-supplied-53-->


	  <!--RULE -->
   <xsl:template match="tei:supplied" priority="1000" mode="M60">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-straightApos-56-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-LRquotes-57-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-quotationMarks-58-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-doubleHyphens-59-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-rangeHyphen-60-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-ieEg-61-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-nonbreakingspace-62-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-localLinkTarget-63-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-renditionTarget-64-->


	  <!--RULE -->
   <xsl:template match="@rendition" priority="1000" mode="M70">
      <xsl:variable name="orphan.pointers"
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-quoteDelim-65-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-crossref-id-66-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-formalCrossref-67-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-crossrefTargetType-68-->
   ...
   <xsl:template match="tei:ptr[@type='crossref']|tei:ref[@type='crossref']"
      ...
      <xsl:if test="exists($orphan.pointers)">
         <xsl:message>
            ...
            <xsl:value-of select="name(.)"/>
            <xsl:text/>[@type="crossref"]) should be targeted at div, figure, table, or note elements. The target of <xsl:text/>
            <xsl:value-of select="if (count($orphan.pointers) &gt; 1) then 'these pointers' else 'this pointer'"/>
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-crossrefType-69-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-centuries-70-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-teiVersion-71-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.jtei-url-72-->
