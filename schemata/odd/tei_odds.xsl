...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-ptr-ptrAtts-13-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-ref-refAtts-14-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-list-gloss-list-must-have-labels-15-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-relatedItem-targetorcontent1-16-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_odds-l-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-lg-atleast1oflggapl-18-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-lg-abstractModel-structure-l-19-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-quotation-quotationContents-20-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-div-abstractModel-structure-l-23-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-div-abstractModel-structure-p-24-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.repeatable-MINandMAXoccurs-25-->


	  <!--RULE -->
   <xsl:template match="*[ @minOccurs  and  @maxOccurs ]" priority="1001" mode="M31">
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.identified-spec-in-module-26-->
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.deprecated-validUntil-deprecation-two-month-warning-27-->


	  <!--RULE -->
   <xsl:template match="tei:*[@validUntil]" priority="1000" mode="M33">
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.deprecated-validUntil-deprecation-should-be-explained-28-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-moduleRef-modref-29-->
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-moduleRef-prefix-not-same-prefix-30-->


	  <!--RULE -->
   <xsl:template match="tei:moduleRef" priority="1000" mode="M36">
   ...
   <!--PATTERN schematron-constraint-tei_odds-model-no_dup_default_models-31-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-model-no_dup_models-32-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-modelSequence-no_outputs_nor_predicates_4_my_kids-33-->


	  <!--RULE -->
   <xsl:template match="tei:modelSequence" priority="1000" mode="M39">
   ...
   <!--PATTERN schematron-constraint-tei_odds-sequence-sequencechilden-34-->


	  <!--RULE -->
   <xsl:template match="tei:sequence" priority="1000" mode="M40">
   ...
   <!--PATTERN schematron-constraint-tei_odds-alternate-alternatechilden-35-->


	  <!--RULE -->
   <xsl:template match="tei:alternate" priority="1000" mode="M41">
   ...
   <!--PATTERN schematron-constraint-tei_odds-constraintSpec-sch_no_more-36-->


	  <!--RULE -->
   <xsl:template match="tei:constraintSpec" priority="1000" mode="M42">
   ...
   <!--PATTERN schematron-constraint-tei_odds-constraintSpec-isosch-37-->


	  <!--RULE -->
   <xsl:template match="tei:constraintSpec" priority="1000" mode="M43">
   ...
   <!--PATTERN schematron-constraint-tei_odds-constraintSpec-needrules-38-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-attDef-attDefContents-39-->


	  <!--RULE -->
   <xsl:template match="tei:attDef" priority="1000" mode="M45">
   ...
   <!--PATTERN schematron-constraint-tei_odds-attDef-noDefault4Required-40-->


	  <!--RULE -->
   <xsl:template match="tei:attDef[@usage eq 'req']" priority="1000" mode="M46">
   ...
   <!--PATTERN schematron-constraint-tei_odds-attDef-defaultIsInClosedList-twoOrMore-41-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-attDef-defaultIsInClosedList-one-42-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-dataRef-restrictDataFacet-43-->


	  <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M49">
   ...
   <!--PATTERN schematron-constraint-tei_odds-dataRef-restrictAttRestriction-44-->


	  <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M50">
   ...
   <!--PATTERN schematron-constraint-tei_odds-link-linkTargets3-45-->


	  <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M51">
   ...
   <!--PATTERN schematron-constraint-tei_odds-ab-abstractModel-structure-ab-46-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-ab-abstractModel-structure-l-47-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-join-joinTargets3-48-->


	  <!--RULE -->
   <xsl:template match="tei:join" priority="1000" mode="M54">
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-standOff-nested_standOff_should_be_typed-49-->


	  <!--RULE -->
   <xsl:template match="tei:standOff" priority="1000" mode="M55">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:value" priority="1000" mode="M56">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:unicodeName" priority="1000" mode="M57">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:localName" priority="1000" mode="M58">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:glyphName" priority="1000" mode="M59">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:charProp" priority="1000" mode="M60">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:charName" priority="1000" mode="M61">
