...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-ptr-ptrAtts-13-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-ref-refAtts-14-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-list-gloss-list-must-have-labels-15-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relatedItem-targetorcontent1-16-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_ms-l-abstractModel-structure-l-17-->


	  <!--RULE -->
   <xsl:template match="tei:l" priority="1000" mode="M21">
   ...
   <!--PATTERN schematron-constraint-tei_ms-lg-atleast1oflggapl-18-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-lg-abstractModel-structure-l-19-->


	  <!--RULE -->
   <xsl:template match="tei:lg" priority="1000" mode="M23">
   ...
   <!--PATTERN schematron-constraint-tei_ms-quotation-quotationContents-20-->


	  <!--RULE -->
   <xsl:template match="tei:quotation" priority="1000" mode="M24">
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-link-linkTargets3-21-->


	  <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M25">
   ...
   <!--PATTERN schematron-constraint-tei_ms-ab-abstractModel-structure-ab-22-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-ab-abstractModel-structure-l-23-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-join-joinTargets3-24-->


	  <!--RULE -->
   <xsl:template match="tei:join" priority="1000" mode="M28">
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-standOff-nested_standOff_should_be_typed-25-->


	  <!--RULE -->
   <xsl:template match="tei:standOff" priority="1000" mode="M29">
   ...
   <!--PATTERN schematron-constraint-tei_ms-div-abstractModel-structure-l-28-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-div-abstractModel-structure-p-29-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-reforkeyorname-30-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-activemutual-31-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-activepassive-32-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-objectIdentifier-objectIdentifier_minimal-33-->


	  <!--RULE -->
   <xsl:template match="tei:objectIdentifier" priority="1000" mode="M35">
   ...
   <!--PATTERN schematron-constraint-tei_ms-path-pathmustnotbeclosed-34-->


	  <!--RULE -->
   <xsl:template match="tei:path[@points]" priority="1000" mode="M36">
   ...
   <!--PATTERN schematron-constraint-tei_ms-addSpan-spanTo-35-->


	  <!--RULE -->
   <xsl:template match="tei:addSpan" priority="1000" mode="M37">
   ...
   <!--PATTERN schematron-constraint-tei_ms-damageSpan-spanTo-37-->


	  <!--RULE -->
   <xsl:template match="tei:damageSpan" priority="1000" mode="M38">
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-delSpan-spanTo-39-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-subst-substContents1-41-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-catchwords-catchword_in_msDesc-42-->


	  <!--RULE -->
   <xsl:template match="tei:catchwords" priority="1000" mode="M41">
   ...
   <!--PATTERN schematron-constraint-tei_ms-dimensions-duplicateDim-43-->


	  <!--RULE -->
   <xsl:template match="tei:dimensions" priority="1000" mode="M42">
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-secFol-secFol_in_msDesc-44-->


	  <!--RULE -->
   <xsl:template match="tei:secFol" priority="1000" mode="M43">
   ...
   <!--PATTERN schematron-constraint-tei_ms-signatures-signatures_in_msDesc-45-->


	  <!--RULE -->
   <xsl:template match="tei:signatures" priority="1000" mode="M44">
   ...
   <!--PATTERN schematron-constraint-tei_ms-msIdentifier-msId_minimal-46-->
